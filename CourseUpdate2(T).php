<?php
    ...
    if ($id) {
        ...
        echo "<script>alert('No Course ID specified'); window.location.href='CourseView(T).php';</script>";
        exit;
    }
    ...
    if (isset($_POST['CourseUpdate'])) {
        ...
        if ($result2) {
            echo "<script>alert('Update Successful'); window.location.href='CourseView(T).php?IDCourse=$id';</script>";
        } else {
            echo "<script>alert('Update Failed'); window.location.href='CourseUpdate2(T).php?IDCourse=$id';</script>";
        }
    }
...
<html>
<head>
    <link rel="stylesheet" href="CourseUpdate2(T).css">
</head>
