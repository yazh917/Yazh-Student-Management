...
<head>
	...
	<link rel="stylesheet"  href="StudentUpdate(T).css">

</head>

<body background="BGTHUS.gif" class="BG" >
		...
		<h1 class="TitleView" ><center>List of Yazh Student<center></h1>
				...
				<tr>
					...
					<td class="td_design">
						...
						<a href="StudentUpdate2(T).php?StudentID=<?php echo $STInfo['StudentID']; ?>"><button type="button" class="Updatebtn" >Update</button></a>
